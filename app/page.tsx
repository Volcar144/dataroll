        ...
        <main className="flex min-h-screen w-full max-w-3xl flex-col items-center justify-center gap-8 py-32 px-16 bg-white dark:bg-black">
          ...
          <div className="flex flex-col items-center text-center mt-8">
            ...
            <p className="mt-4 text-sm text-zinc-600 dark:text-zinc-400 max-w-md">
              A comprehensive database migration manager with advanced authentication features including passkeys, two-factor authentication, and password breach detection.
            </p>
            <div className="mt-8 flex gap-4">
              <Link
                href="/auth/signin"
                className="rounded-md bg-zinc-900 px-4 py-2 text-white hover:bg-zinc-800 focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2 dark:bg-zinc-100 dark:text-zinc-900 dark:hover:bg-zinc-200"
              >
                Sign In
              </Link>
              <Link
                href="/auth/signup"
                className="rounded-md border border-zinc-300 bg-white px-4 py-2 text-zinc-900 hover:bg-zinc-50 focus:outline-none focus:ring-2 focus:ring-zinc-500 focus:ring-offset-2 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100 dark:hover:bg-zinc-700"
              >
                Sign Up
              </Link>
            </div>
        ...
        <div className="text-center">
          ...
          <div className="mt-8 space-y-4">
            <div className="text-sm text-zinc-600 dark:text-zinc-400">
              <strong>Authentication Features Available:</strong>
