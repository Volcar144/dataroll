...
import { Plus, Save, Trash2, Play, Settings, Type } from 'lucide-react'
    ...
    <div className="h-screen flex flex-col bg-zinc-50 dark:bg-black">
      ...
      <div className="flex items-center justify-between border-b border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
        <div className="flex-1">
          <input
            ...
            className="mb-1 block w-full text-xl font-semibold bg-transparent focus:outline-none dark:text-zinc-100"
          />
          <input
            type="text"
      ...
      <div className="flex-1 relative">
        <ReactFlow
          ...
          fitView
          onClick={(e) => {
            if ((e.target as any)?.closest?.('[data-id]')) return
            setSelectedNode(null)
          }}
        ...
        {/* Node Inspector */}
        {selectedNode && (
          <div className="absolute bottom-4 right-4 w-64 rounded-lg border border-zinc-200 bg-white p-4 shadow-lg dark:border-zinc-800 dark:bg-zinc-900">
